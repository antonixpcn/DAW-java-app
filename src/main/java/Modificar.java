...
public class Modificar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Modificar Libro</title>");
            out.println("<link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css' rel='stylesheet'>");
            out.println("</head>");
            out.println("<body>");
            out.println("<div class='container mt-5'>");

            out.println("<h3 class='mb-4'>Modificar un Libro</h3>");
            out.println("<form action='modificar' method='post' class='mb-4'>");
            ...
            out.println("</div>");
            out.println("<button type='submit' class='btn btn-primary'>Modificar Libro</button>");
            out.println("</form>");

            // Si hubo una modificación exitosa, mostrar un mensaje
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Consulta SQL para modificar un libro existente
            ...
            if (result > 0) {
                request.setAttribute("mensaje", "Libro modificado correctamente");
            } else {
                request.setAttribute("mensaje", "Error al modificar el libro");
            }
            ...
            throw new ServletException("Error al modificar el libro", e);
        }
    }
}
